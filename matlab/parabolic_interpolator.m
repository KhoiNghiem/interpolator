...
plot(t_interp, x_parabolic_row, 'r', 'LineWidth', 1.5, 'DisplayName', 'Piecewise parabolic Interpolation x1[m]');
...
ylabel('Amplitude');
legend;
title('Original Signal vs Piecewise parabolic Interpolation x1[m]');

figure;
stem(t_interp, abs(x_parabolic_row - x_true_row), 'black', 'LineWidth', 1.5);
xlabel('m');
ylabel('Absolute Error');
title('Absolute Error of Piecewise parabolic Interpolation x1[m]');
grid on;
