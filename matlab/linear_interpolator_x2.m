...
plot(t_interp, x_linear_row, 'r', 'LineWidth', 1.5, 'DisplayName', 'Linear Interpolation');
...
ylabel('Amplitude');
legend;
title('Original Signal vs Linear Interpolation x2[m]');

figure;
stem(t_interp, abs(x_linear_row - x_true_row), 'black', 'LineWidth', 1.5);
xlabel('m');
ylabel('Absolute Error');
title('Absolute Error of Linear Interpolation x2[m]');
grid on;
