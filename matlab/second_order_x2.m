...
plot(t_interp, x_poly2_row, 'r', 'LineWidth', 1.5, 'DisplayName', 'Second-order polynomial Interpolation x2[m]');
...
ylabel('Amplitude');
legend;
title('Original Signal vs Second-order polynomial Interpolation x2[m]');

figure;
stem(t_interp, abs(x_poly2_row - x_true_row), 'black', 'LineWidth', 1.5);
xlabel('m');
ylabel('Absolute Error');
title('Absolute Error of Second-order polynomial Interpolation x2[m]');
grid on;
