...
title('Piecewise Parabolic Interpolation Comparison: TF32 vs Double vs Ground Truth x1[m]');

figure;
stem(t_interp, abs(x_parabolic_row_double - x_parabolic_row_tf32), 'black', 'LineWidth', 1.5);
xlabel('m');
ylabel('Absolute Error');
title('Absolute Error of Piecewise parabolic Interpolation x1[m] Bitrue Model');
grid on;
